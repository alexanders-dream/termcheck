...
export async function analyzeWithAnthropic(text: string, apiKey: string, systemPrompt: string): Promise<LegalFlag[]> {
  try {
...
export async function analyzeWithGroq(text: string, apiKey: string, systemPrompt: string): Promise<LegalFlag[]> {
  try {
...
export async function analyzeWithGemini(text: string, apiKey: string, systemPrompt: string): Promise<LegalFlag[]> {
  try {
